...
if($loggedin){
  echo'
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" style="color:white;"">Student Room</a>
  ...
  <div class="">
    ...
    if($_SESSION['user_type_id'] == 1)
    {
      ...
      <a class="nav-link" href="/studentroom/admin_welcome.php">Home<span class="sr-only"></span></a>
      </li>
    ...
    else
    {
      ...
      <a class="nav-link" href="/studentroom/user_welcome.php">Home<span class="sr-only"></span></a>
      </li>'
      ;
    }
