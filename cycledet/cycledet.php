...
<body>
    ...
    <div class="container my-5">
        ...
        <span class="border">
            ...
            <ul>
                <li>Iterate over all the nodes of the graph and Keep a visited array <i>visited[]</i> to track the
                    visited
                    nodes.</li>
                ...
                <ul>
                    ...
                    <ul>
                        ...
                        <li>Else if the adjacent node is visited and not the parent of the current node then return
                            true.
                        </li>
                    </ul>
                    <li>Return false.</li>
