    ...
    <div class="container">
        ...
        <div class="row">
            <div class="card">
                ...
                <a href="../details/r_details_cmr.php" class="btn">Details</a>
            </div>

            <div class="card">
                <img src="../images/kashem.jpg" alt="">
                ...
                <a href="../details/r_details_kashem.php" class="btn">Details</a>
            </div>

            <div class="card">
                <img src="../images/dewan.png" alt="">
                <h3>FARID, DEWAN MD.,<i>&nbspPh.D.</i></h3>
                <p>Professor</p>
                <p>Email :<a href="mailto: dewanfarid@cse.uiu.ac.bd">dewanfarid@cse.uiu.ac.bd</a></p> 
                <a href="../details/r_details_dewan.php" class="btn">Details</a>
            </div>
            ...
            <div class="card">
                ...
                <a href="../details/r_details_huda.php" class="btn">Details</a>
            </div>

            <div class="card">
                <img src="../images/Muzahidul.jpg" alt="">
                ...
                <a href="../details/r_details_muzahidul.php" class="btn">Details</a>
            </div>

            <div class="card">
                <img src="../images/motaharul.jpg" alt="">
                <h3>ISLAM, MD. MOTAHARUL,<i>&nbspPh.D.</i></h3>
                <p>Professor</p>
                <p>Email :<a href="mailto: motaharul@cse.uiu.ac.bd">motaharul@cse.uiu.ac.bd</a></p> 
                <a href="../details/r_details_motaharul.php" class="btn">Details</a>
            </div>

            <div class="card">
                <img src="../images/salekul.jpg" alt="">
                ...
                <a href="../details/r_details_salekul.php" class="btn">Details</a>
            </div>
            ...
            <div class="card">
                ...
                <a href="../details/r_details_mamun.php" class="btn">Details</a>
            </div>

            <div class="card">
                <img src="../images/pathan.jpg" alt="">
                <h3>PATHAN, AL-SAKIB KHAN,<i>&nbspPh.D.</i></h3>
                <p>Professor</p>
                <p>Email :<a href="mailto: sakib@cse.uiu.ac.bd">sakib@cse.uiu.ac.bd</a></p> 
                <a href="../details/r_details_pathan.php" class="btn">Details</a>
            </div>

            <div class="card">
                <img src="../images/Shahriar.jpg" alt="">
                ...
                <a href="../details/r_details_shahriar.php" class="btn">Details</a>
            </div>
            ...
            <div class="card">
                ...
                <a href="../details/r_details_hasan.php" class="btn">Details</a>
            </div>

            <div class="card">
                <img src="../images/swakkhar.jpg" alt="">
                ...
                <a href="../details/r_details_swakkhar.php" class="btn">Details</a>
            </div>
        ...
        <div class="button">
            <a href="r_profiles1.php" class="previous" style="background-color: orangered; color:white">1</a>
            <a href="r_profiles2.php" class="next">2</a>
            <a href="r_profiles3.php" class="next">3</a>
            <a href="r_profiles4.php" class="next">4</a>
        </div>  
    </div>
