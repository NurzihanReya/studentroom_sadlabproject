...
?>
    ...
    <span class="border">
        ...
        <p>Each internal node is of the form: (P1, K1, P2, K2, ….., Pc-1, Kc-1, Pc) where c <= a and each Pi is a tree
                pointer (i.e points to another node of the tree) and, each Ki is a key-value.<br>
                Every internal node has : K1 < K2 < …. < Kc-1.<br>
                    ...
                    holds : Ki-1 < X <=Ki, for 1 < i < c and, Ki-1 < X, for i=c Each internal node has at most a tree
                        pointers. The root node has, at least two tree pointers, while the other internal nodes have at
                        least ceil(a/2) tree pointers each. If an internal node has c pointers, c <=a, then it has c – 1
                        key values.<br>
                        <hr>
        </p>
        </p>
