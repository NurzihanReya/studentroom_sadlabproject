...
<body>
    ...
    <div class="container my-5">
        <span class="border">
            <p>In Prim’s algorithm, two sets are maintained, one set contains list of vertices already included in
                ...
                connects the two sets. Here we use one in <b>MST[V]</b>. The value of <b>MST[i]</b> is going to be true
                if
            ...
            <p>The idea behind Prim’s algorithm is simple, a spanning tree means all vertices must be connected. So the
                two
                disjoint subsets (discussed above) of vertices must be connected to make a Spanning Tree. And they must
                be
                connected with the minimum weight edge to make it a Minimum Spanning Tree.</p><br>
            ...
            <ol>
                ...
                <li>The key values are used only for vertices that are not yet included in MST, the key value for these
                    vertices indicates the minimum weight edges connecting them to the set of vertices included in MST.
                </li>
